...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-primary" id="hidepanel1">
                ...
                <p style="color: rgb(224, 109, 109);"><i class="fa fa-fw fa-bell"></i> تحذير: سيتم حذف جميع الاعضاء التابعين لهذه المجموعة مع حذف المجموعة</p>
