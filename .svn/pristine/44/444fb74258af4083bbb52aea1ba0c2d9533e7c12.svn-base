...
@extends('backend.master')
            @section('content-header')
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">حذف الاخبار</li>
                </ol>
            @stop
            <!--section ends-->
@section('content')
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-primary" id="hidepanel1">
                ...
                <p style="color: rgb(224, 109, 109);"><i class="fa fa-fw fa-bell"></i> تحذير: سيتم حذف جميع الالبومات التابعة للخبر مع حذف الخبر</p>
