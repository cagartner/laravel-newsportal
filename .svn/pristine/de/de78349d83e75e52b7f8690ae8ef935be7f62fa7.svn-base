...
@section('content-header')
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">تعديل الروابط</li>
                </ol>
            @stop
@endsection
     ...
     <div class="col-md-12">
        <div class="panel panel-primary">
            <div class="panel-heading">
                        <h3 class="panel-title"><i class="livicon" data-name="edit" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true"></i>تعديل الروابط</h3>
            </div>
                    ...
                    <div class="col-md-12">
                        <form action="{{ action('MenusController@update_link', [$link->menu_id, $link->id]) }}" method="POST" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title" value="@if(old('title')){{ old('title') }}@else{{$link->title}}@endif" placeholder="title">
                            </div>
                            <div class="form-group">
                                <label for="link">الرابط</label>
                                <input type="text" class="form-control" name="link" value="@if(old('link')){{ old('link') }}@else{{$link->link}}@endif" placeholder="link">
                                <p class="help-block">
                            ...
                            <div class="form-group">
                                ...
                                <select name="menu" id="" class="form-control">
                                    ...
                                    <option value="{{ $menu->id }}" @if(old('menu') == $menu->id) selected @elseif($link->menu_id == $menu->id) selected @endif>{{ $menu->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            {{-- <div class="form-group">
