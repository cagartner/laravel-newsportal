                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        {!! Form::model($news, [$news->id, 'files' => true, 'method' => 'POST', 'class'=>'form-wizard']) !!}
                                            ...
                                            <div class="row">
                                                        ...
                                                        <div class="form-group" style="background-color: #EEEBEB;padding: 10px;border: 1px solid;">
                                                            ...
                                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                                    @if ($news->basic_photo->count())
                                                                        @foreach($news->basic_photo as $image)
                                                                            <img src="/{{$image->original_size}}" alt="{{$news->title}}" style="height:100%">
                                                                        @endforeach
                                                                    @else
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                            <label>العنوان</label>
                                                            <input id="userName" name="title" type="text" placeholder="عنوان الخبر" class="form-control" value="{{$news->title}}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>الملخص</label>
                                                           
                                                                <input name="summary" type="text" placeholder="ملخص الخبر" class="form-control" value="{{$news->summary}}">
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label>المؤلف</label>
                                                            <input name="author" type="text" class="form-control" value="{{$news->author}}">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="news_subject" rows="7" id="news_subject">{!! $news->subject !!}</textarea>
                                                </div>
                                                <script>
                                                   CKEDITOR.replace('news_subject');
                                                </script>
                                                <div class="form-group">
                                                    @if ($news->publish_facebook== 1)
                                                        <input type="checkbox" name="publish" value="checked" checked> <b>نشر الخبر على الفيس بوك و تويتر</b>
                                                    @else
                                            ...
                                            <section>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @if ($news->features->count())
                                                        @foreach($news->features as $item)
                                                        @if ($item->status == 1)
                                                            @if ($item->feature == 1)
                                                                <input type="checkbox" name="1" value="checked" checked><b>وضع الخبر ضمن الاخبار الهامة</b><br>
                                                            @endif
                                                            @if ($item->feature == 2)
                                                                <input type="checkbox" name="2" value="checked" checked><b>وضع الخبر ضمن الاخبار العاجلة</b><br>
                                                            @endif
                                                            @if ($item->feature == 3)
                                                                <input type="checkbox" name="3" value="checked" checked><b>عرض الخبر في الشريط الاخباري</b><br>
                                                            @endif
                                                            @if ($item->feature == 4)
                                                                <input type="checkbox" name="4" value="checked" checked><b>وضع الخبر ضمن الاحداث الهامة</b><br>
                                                            @endif
                                                            @if ($item->feature == 5)
                                                                <input type="checkbox" name="5" value="checked" checked><b>ارسال اشعار بالخبر</b><br>
                                                            @endif
                                                            @if ($item->feature == 6)
                                                                <input type="checkbox" name="6" value="checked" checked><b>ارسال SMS للمشتركين بالخدمة الاخبارية</b><br>
                                                            @endif
                                                        @else
                                                            @if ($item->feature == 1)
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="advantage" class="form-control">
                                                        ...
                                                        <option value="1" @if($news->advantage == 1) selected @endif>
                                                            تغطية
                                                        </option>
                                                        <option value="2" @if($news->advantage == 2) selected @endif>
                                                            انفراد
                                                        </option>
                                                        <option value="3" @if($news->advantage == 3) selected @endif>
                                                            بالفيديو
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <select name="comments" class="form-control">
                                                        <option value="1" @if($news->comments_status == 1) selected @endif>
                                                            مسموح
                                                        </option>
                                                        <option value="2" @if($news->comments_status == 2) selected @endif>
                                                            غير مسموح
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    @foreach ($sections as $section)
                                                        @foreach ($news->sections as $secitem)
                                                            @if ($secitem->section == $section->id)
                                                                @if ($secitem->status == 1)
                                                                    <input type="checkbox" name="{{$section->id}}" value="checked" checked> <b>{{$section->name}}</b><br>
                                                                @else
                                            ...
                                            <section>
                                                <h2 class="hidden">&nbsp;</h2>
                                                @foreach ($news->palbums as $palbum)
                                                @if (!empty($palbum->name) || !empty($palbum->subject))
                                                    <div class="form-group">
                                                        <label>اسم الالبوم</label>
                                                        <input name="pablum_name" type="text" class="form-control" value="{{$palbum->name}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>المصور</label>
                                                        <input name="pablum_photographer" type="text" class="form-control" value="{{$palbum->photographer}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>ملخص الالبوم</label>
                                                        <input name="pablum_summary" type="text" class="form-control" value="{{$palbum->summary}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>موضوع الالبوم</label>
                                                        <textarea class="form-control" name="pablum_subject" id="pablum_subject" rows="7">{!! $palbum->subject !!}</textarea>
                                                    </div>
                                                    <script>
                                                       CKEDITOR.replace('pablum_subject');
                                                    </script>
                                                    <div class="form-group">
                                                        <input type="checkbox" name="palbum_publish_on_home" value="checked" @if ($palbum->publish_on_home == 1) checked @endif> <b>نشر الالبوم في الصفحة الرئيسية</b><br>
                                                    </div>
                                                    <div class="form-group">
                                                    @if ($palbums_photo->count())
                                                    {!! Form::label('الصور') !!}<br>

                                                        <div class="photos_block">
                                                            <div class="fileinput-new thumbnail" style="height: auto;">
                                                            <div class="row" style="margin-left: 1px;">
                                                            
                                                                @foreach($palbums_photo as $photo)
                                                                @if ($palbum->id == $photo->news_photo_album_id)
                                                                            <div class="col-md-3">
                                                                            <img src="/{{$photo->thumbnail}}" alt="{{$palbum->name}}" style="width: 190px;">
                                                                            {!! Form::button('x', 
                                                                                array('class'=>'btn btn-primary delete_photo_ajax', 'value'=>$photo->id)) !!}
                                                                            </div>
                                                                @endif
                                                                @endforeach
                                                            @else
                                                ...
                                                @endforeach
                                                <div class="form-group">
                                                    <input name="destroy_images" type="text" class="destroy_images">
                                                </div>
                                                </section>

                                            <h1>البوم الفيديو</h1>
                                            <section>
                                            @if ($news->valbums->count())
                                            @foreach ($news->valbums as $vitem)
                                                <div class="form-group">
                                                    <label>اسم الالبوم</label>
                                                    <input name="vablum_name" type="text" class="form-control" value="{{$vitem->name}}">
                                                </div>
                                                <div class="form-group">
                                                    <label>المصور</label>
                                                    <input name="vablum_photographer" type="text" class="form-control" value="{{$vitem->photographer}}">
                                                </div>
                                                <div class="form-group">
                                                    <label>ملخص الالبوم</label>
                                                    <input name="vablum_summary" type="text" class="form-control" value="{{$vitem->summary}}">
                                                </div>
                                                <div class="form-group">
                                                    <label>موضوع الالبوم</label>
                                                    <textarea class="form-control" name="vablum_subject" id="vablum_subject" rows="7">{!! $vitem->subject !!}</textarea>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                        ...
                                                        @if ($valbums_video->count())
                                                        <?php $i = 2 ?>
                                                        @foreach($valbums_video as $video)
                                                        @if ($video->news_video_album_id == $vitem->id)
                                                            <input name="vablum_videos_{{$i}}" type="text" class="form-control" style="width:95%;" placeholder="اضف الفيديو" value="{{$video->video}}">
                                                ...
                                                <div class="form-group">
                                                    <input type="checkbox" name="valbum_publish_on_home" value="checked" @if ($vitem->publish_on_home == 1) checked @endif> <b>نشر الالبوم في الصفحة الرئيسية</b><br>
                                                </div>
                                                <?php break; ?>
                                                @endforeach
                                                @else
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                    ...
                                                    @if ($news->tags->count())
                                                    <?php $avail_tags = ''; ?>
                                                    @foreach($news->tags as $mytags)
                                                        <?php $avail_tags = "#" . $mytags->tags . $avail_tags; ?>
                                                    @endforeach
                                                    <input name="new_tag" type="text" placeholder="هاش تاج جديد" class="form-control" value="{{$avail_tags}}">
                                                    @else
...
<script src="{{ asset('assets/backend/vendors/livicons/minified/raphael-min.js') }}" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        $('li.select2-search-choice').children().css('margin-right', '10px');
    </script>
    <script type="text/javascript">  
        $(document).ready(function(){
            ...
            var images = '';
            $(document).on('click','button.btn.btn-primary.delete_photo_ajax',function(){
                $(this).prev().hide();
                $(this).hide();
                var photo_id = $(this).val();
                var destroy_images = $('.destroy_images').val();
                images = destroy_images + '-' + photo_id;
                
                $('.destroy_images').val(images);
                $('.destroy_images').show();
            });
        });  
    </script>
