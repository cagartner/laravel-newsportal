...
@section('content-header')
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">تحديث الصفحات</li>
                </ol>
            @stop
@endsection
     ...
     <div class="col-md-12">
        <div class="panel panel-primary">
            <div class="panel-heading">
                        <h3 class="panel-title"><i class="livicon" data-name="user-add" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true"></i>{{ trans('pages.edit_page') }}</h3>
            </div>
                    ...
                    <div class="col-md-12">
                        <form action="{{ action('PagesController@update', $page->id) }}" method="POST" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title" value="@if(old('title')){{ old('title') }}@else{{$page->title}}@endif" placeholder="{{ trans('pages.title') }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        <input name="menu_active" id="menu-active" type="checkbox" value="1" @if(old('menu-active') == '1') checked @elseif($page->menu_active == '1') checked @endif>
                            ...
                            <div class="form-group" id="menu-group">
                                ...
                                <select name="menu" class="form-control">
                                    ...
                                    <option value="{{ $menu->id }}"@if( old('menu') == $menu->id) @elseif(isset($link_menu_id) && $menu->id == $link_menu_id) selected @endif>{{ $menu->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            @endif
