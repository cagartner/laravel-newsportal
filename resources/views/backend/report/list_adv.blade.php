        ...
        @if ($view->status == 1 && $view->permission == 12) 
            ...
            @section('content-header')
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">تقارير الاعلانات</li>
                </ol>
            @stop
            <!--section ends-->
            @section('content')
                                	...
                                	@if ($adv->count())
                                    	...
                                    	@foreach ($adv as $view)
	                                        <tr>
	                                            ...
	                                            <td>
	                                                <a href="/admin/report/advertisements/print/{{$view->id}}"><i class="fa fa-fw fa-print"></i>طباعة</a> 
	                                            </td>
	                                        </tr>
	                                    @endforeach
	                                @endif
